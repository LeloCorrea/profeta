...
DAILY_SEND_HOUR = env_int("DAILY_SEND_HOUR", 6)
...
# 🔔 ALERTS
ENABLE_ALERTS = env_bool("ENABLE_ALERTS", False)
ALERT_CHAT_ID = os.getenv("ALERT_CHAT_ID", "")
WARNING_THRESHOLD = env_int("WARNING_THRESHOLD", 5)
WARNING_PERSIST_MINUTES = env_int("WARNING_PERSIST_MINUTES", 30)
