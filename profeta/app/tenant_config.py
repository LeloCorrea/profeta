...
class TenantConfig:
    ...
    def from_env(cls) -> "TenantConfig":
        ...
        return cls(
            ...
            feature_share=_env_bool("FEATURE_SHARE", True),
            ...
            branding=TenantBranding(
                ...
                instagram_handle=os.getenv("BRANDING_INSTAGRAM_HANDLE", "@oprofeta.oficial"),
                telegram_handle=os.getenv("BRANDING_TELEGRAM_HANDLE", "@profeta_oficial_bot"),
                telegram_link=os.getenv("BRANDING_TELEGRAM_LINK", "t.me/profeta_oficial_bot"),
                share_cta=os.getenv("BRANDING_SHARE_CTA", "Receba sua Palavra diária no Telegram"),
            ),
        )
